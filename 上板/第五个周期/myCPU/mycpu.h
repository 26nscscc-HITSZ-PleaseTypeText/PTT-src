...
// NSCSCC on-chip RAM is fixed at PA 0x1c000000~0x1c0fffff.  The start-up
// code temporarily gives this DMW window MAT=0 while copying/clearing data.
// Promote only this ordinary RAM range on the D side; MMIO and all other
// mappings keep the exact software-selected attribute.
...
`define TAGE_TAG_DEPTH    1024        // 每个标记表项数
`define TAGE_TAG_W        12          // 标记位宽
`define TAGE_HIST_LEN0    11          // 各标记表全局历史长度（几何级数）
